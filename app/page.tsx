  ...
  return (
    <div className="relative isolate flex h-svh flex-col overflow-hidden bg-paper">
      {/* Credit — top-left, balancing the logo (centre) and Saved entry (right).
          On phones the label is hidden so it can't collide with the centred
          logo; the icon alone stays as a compact, tappable link. The label
          returns at `sm` and up where there's room. Opens GitHub in a new tab;
          rel="noreferrer" drops the referrer and closes the reverse-tabnabbing
          hole that target="_blank" otherwise opens. */}
      <a
        href="https://github.com/houdaspace28"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Made with love by houda & claude — GitHub"
      ...
      >
        ...
        <span className="hidden sm:inline">with love, houda &amp; claude</span>
      </a>
